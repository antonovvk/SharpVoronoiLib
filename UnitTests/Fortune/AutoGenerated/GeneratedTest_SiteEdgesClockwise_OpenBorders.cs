...
namespace SharpVoronoiLib.UnitTests
{
    ...
    public class GeneratedTest_SiteEdgesClockwise_OpenBorders
    {
        ...
        public void ThreePointsInAWedgeTowardsCornerOffset()
        {
            ...
            Assert.IsTrue(EdgeIs(sites[0].ClockwiseCell.ElementAt(0), 300, 600, 700, 1000)); // #1 A-D
            Assert.IsTrue(EdgeIs(sites[0].ClockwiseCell.ElementAt(1), 300, 600, 0, 600)); // #1 A-B
            Assert.AreEqual(2, sites[1].ClockwiseCell.Count()); // #2
        ...
        public void ThreePointsInAWedgeTowardsCornerOffset_Rotated90()
        {
            ...
            Assert.IsTrue(EdgeIs(sites[1].ClockwiseCell.ElementAt(0), 600, 700, 600, 1000)); // #2 A-B
            Assert.IsTrue(EdgeIs(sites[1].ClockwiseCell.ElementAt(1), 600, 700, 0, 700)); // #2 A-C
            Assert.AreEqual(2, sites[2].ClockwiseCell.Count()); // #3
        ...
        public void ThreePointsInAWedgeTowardsCornerOffset_Rotated180()
        {
            ...
            Assert.IsTrue(EdgeIs(sites[2].ClockwiseCell.ElementAt(0), 700, 400, 700, 1000)); // #3 A-C
            Assert.IsTrue(EdgeIs(sites[2].ClockwiseCell.ElementAt(1), 700, 400, 300, 0)); // #3 A-D
        }
        ...
        public void ThreePointsInAWedgeTowardsCornerOffset_MirroredAndRotated90()
        {
            ...
            Assert.IsTrue(EdgeIs(sites[1].ClockwiseCell.ElementAt(0), 600, 300, 600, 0)); // #2 A-B
            Assert.IsTrue(EdgeIs(sites[1].ClockwiseCell.ElementAt(1), 600, 300, 0, 300)); // #2 A-C
            Assert.AreEqual(2, sites[2].ClockwiseCell.Count()); // #3
        ...
        public void ThreePointsInAWedgeTowardsCornerOffset_MirroredAndRotated180()
        {
            ...
            Assert.IsTrue(EdgeIs(sites[1].ClockwiseCell.ElementAt(1), 300, 400, 0, 400)); // #2 A-B
            Assert.AreEqual(2, sites[2].ClockwiseCell.Count()); // #3
        ...
        public void ThreePointsInAWedgeTowardsSideOffsetIntoMiddle_Rotated180()
        {
            ...
            Assert.IsTrue(EdgeIs(sites[0].ClockwiseCell.ElementAt(0), 500, 300, 1000, 800)); // #1 A-B
            Assert.IsTrue(EdgeIs(sites[0].ClockwiseCell.ElementAt(1), 500, 300, 0, 800)); // #1 A-C
            Assert.AreEqual(2, sites[1].ClockwiseCell.Count()); // #2
        ...
        public void ThreePointsInAWedgeTowardsSideOffsetIntoMiddle_Rotated270()
        {
            ...
            Assert.IsTrue(EdgeIs(sites[1].ClockwiseCell.ElementAt(0), 300, 500, 800, 1000)); // #2 A-C
            Assert.IsTrue(EdgeIs(sites[1].ClockwiseCell.ElementAt(1), 300, 500, 0, 500)); // #2 A-D
            Assert.AreEqual(2, sites[2].ClockwiseCell.Count()); // #3
        ...
        public void FourEquidistantPointsInASquareAroundMiddle()
        {
            ...
            Assert.IsTrue(EdgeIs(sites[0].ClockwiseCell.ElementAt(0), 500, 500, 500, 1000)); // #1 A-B
            Assert.IsTrue(EdgeIs(sites[0].ClockwiseCell.ElementAt(1), 500, 500, 0, 500)); // #1 A-C
            Assert.AreEqual(2, sites[1].ClockwiseCell.Count()); // #2
        ...
        public void FourEquidistantPointsInARectangleAroundMiddle_Rotated90()
        {
            ...
            Assert.IsTrue(SiteHasClockwiseEdge(sites[1], 500, 500, 0, 500)); // #2 has A-D
            Assert.IsTrue(EdgeIs(sites[1].ClockwiseCell.ElementAt(0), 500, 500, 500, 1000)); // #2 A-C
            Assert.IsTrue(EdgeIs(sites[1].ClockwiseCell.ElementAt(1), 500, 500, 0, 500)); // #2 A-D
            Assert.AreEqual(2, sites[2].ClockwiseCell.Count()); // #3
            Assert.IsTrue(SiteHasClockwiseEdge(sites[2], 500, 500, 0, 500)); // #3 has A-D
        ...
        public void FivePointsInAForkedTallCross()
        {
            ...
            Assert.IsTrue(EdgeIs(sites[0].ClockwiseCell.ElementAt(0), 500, 700, 800, 1000)); // #1 B-D
            ...
            Assert.IsTrue(EdgeIs(sites[1].ClockwiseCell.ElementAt(1), 500, 400, 500, 700)); // #2 A-B
            Assert.IsTrue(EdgeIs(sites[1].ClockwiseCell.ElementAt(2), 500, 400, 0, 400)); // #2 A-E
            Assert.AreEqual(2, sites[2].ClockwiseCell.Count()); // #3
            ...
            Assert.IsTrue(EdgeIs(sites[4].ClockwiseCell.ElementAt(1), 500, 400, 1000, 400)); // #5 A-F
        ...
        public void FivePointsInAForkedTallCross_Rotated90()
        {
            ...
            Assert.IsTrue(EdgeIs(sites[1].ClockwiseCell.ElementAt(1), 700, 500, 1000, 800)); // #2 B-C
            Assert.IsTrue(EdgeIs(sites[1].ClockwiseCell.ElementAt(2), 400, 500, 700, 500)); // #2 A-B
            Assert.AreEqual(2, sites[2].ClockwiseCell.Count()); // #3
            ...
            Assert.IsTrue(EdgeIs(sites[2].ClockwiseCell.ElementAt(0), 400, 500, 400, 1000)); // #3 A-E
            Assert.IsTrue(EdgeIs(sites[2].ClockwiseCell.ElementAt(1), 400, 500, 0, 500)); // #3 A-G
            Assert.AreEqual(2, sites[3].ClockwiseCell.Count()); // #4
        ...
        public void FivePointsInAForkedTallCross_Rotated180()
        {
            ...
            Assert.IsTrue(EdgeIs(sites[3].ClockwiseCell.ElementAt(0), 500, 600, 500, 1000)); // #4 A-G
            Assert.IsTrue(EdgeIs(sites[3].ClockwiseCell.ElementAt(1), 500, 600, 0, 600)); // #4 A-F
            Assert.AreEqual(3, sites[4].ClockwiseCell.Count()); // #5
        ...
        public void FivePointsInAForkedTallCross_Rotated270()
        {
            ...
            Assert.IsTrue(EdgeIs(sites[4].ClockwiseCell.ElementAt(0), 600, 500, 600, 1000)); // #5 A-F
        ...
        public void FivePointsInAForkedStubbyCross()
        {
            ...
            Assert.IsTrue(EdgeIs(sites[0].ClockwiseCell.ElementAt(0), 500, 500, 1000, 1000)); // #1 B-D
            ...
            Assert.IsTrue(EdgeIs(sites[1].ClockwiseCell.ElementAt(1), 500, 300, 500, 500)); // #2 A-B
        ...
        public void FivePointsInAForkedStubbyCross_Rotated90()
        {
            ...
            Assert.IsTrue(EdgeIs(sites[1].ClockwiseCell.ElementAt(1), 500, 500, 1000, 1000)); // #2 B-C
            ...
            Assert.IsTrue(EdgeIs(sites[2].ClockwiseCell.ElementAt(0), 300, 500, 300, 1000)); // #3 A-E
            Assert.IsTrue(EdgeIs(sites[2].ClockwiseCell.ElementAt(1), 300, 500, 0, 500)); // #3 A-G
            Assert.AreEqual(2, sites[3].ClockwiseCell.Count()); // #4
            ...
            Assert.IsTrue(EdgeIs(sites[4].ClockwiseCell.ElementAt(2), 300, 500, 300, 0)); // #5 A-F
        }
        ...
        public void SixPointsInADoubleCross()
        {
            ...
            Assert.IsTrue(EdgeIs(sites[0].ClockwiseCell.ElementAt(0), 500, 700, 500, 1000)); // #1 B-H
            Assert.IsTrue(EdgeIs(sites[0].ClockwiseCell.ElementAt(1), 500, 700, 0, 700)); // #1 B-C
            Assert.AreEqual(2, sites[1].ClockwiseCell.Count()); // #2
            ...
            Assert.IsTrue(EdgeIs(sites[2].ClockwiseCell.ElementAt(1), 500, 300, 500, 700)); // #3 A-B
        ...
        public void SixPointsInADoubleCross_Rotated90()
        {
            ...
            Assert.IsTrue(EdgeIs(sites[2].ClockwiseCell.ElementAt(1), 700, 500, 700, 1000)); // #3 B-C
            ...
            Assert.IsTrue(EdgeIs(sites[3].ClockwiseCell.ElementAt(2), 300, 500, 300, 0)); // #4 A-F
            Assert.AreEqual(2, sites[4].ClockwiseCell.Count()); // #5
            ...
            Assert.IsTrue(EdgeIs(sites[4].ClockwiseCell.ElementAt(0), 300, 500, 300, 1000)); // #5 A-D
            Assert.IsTrue(EdgeIs(sites[4].ClockwiseCell.ElementAt(1), 300, 500, 0, 500)); // #5 A-E
            Assert.AreEqual(2, sites[5].ClockwiseCell.Count()); // #6
