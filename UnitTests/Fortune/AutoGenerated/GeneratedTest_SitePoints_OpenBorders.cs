...
namespace SharpVoronoiLib.UnitTests
{
    ...
    public class GeneratedTest_SitePoints_OpenBorders
    {
        ...
        public void OnePointInMiddle()
        {
            ...
            Assert.AreEqual(0, sites[0].Points.Count()); // #1
        }
        ...
        public void TwoPointsVerticalAroundMiddle()
        {
            ...
            Assert.NotNull(sites[0].Points);
            Assert.AreEqual(2, sites[0].Points.Count()); // #1
            ...
            Assert.AreEqual(2, sites[1].Points.Count()); // #2
        ...
        public void ThreeConcentricPointsVerticalAroundMiddle()
        {
            ...
            Assert.AreEqual(2, sites[2].Points.Count()); // #3
        ...
        public void FourConcentricPointsVerticalAroundMiddle()
        {
            ...
            Assert.AreEqual(2, sites[3].Points.Count()); // #4
        ...
        public void SixPointsInADoubleCross()
        {
            ...
            Assert.NotNull(sites[4].Points);
            Assert.AreEqual(3, sites[4].Points.Count()); // #5
            Assert.IsTrue(HasPoint(sites[4].Points, 500, 300)); // #5 has A
            ...
            Assert.AreEqual(3, sites[5].Points.Count()); // #6
