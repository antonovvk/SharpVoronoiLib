...
namespace SharpVoronoiLib.UnitTests
{
    ...
    public class GeneratedTest_SitePointsClockwise_OpenBorders
    {
        ...
        public void ThreePointsInAWedgeTowardsCornerOffset()
        {
            ...
            Assert.IsTrue(SiteHasClockwisePoint(sites[0], 700, 1000)); // #1 has D
            Assert.IsTrue(PointIs(sites[0].ClockwisePoints.ElementAt(0), 700, 1000)); // #1 D
            Assert.IsTrue(PointIs(sites[0].ClockwisePoints.ElementAt(1), 300, 600)); // #1 A
        ...
        public void ThreePointsInAWedgeTowardsCornerOffset_Rotated180()
        {
            ...
            Assert.IsTrue(PointIs(sites[2].ClockwisePoints.ElementAt(1), 700, 400)); // #3 A
        ...
        public void ThreePointsInAWedgeTowardsCornerOffset_Rotated270()
        {
            ...
            Assert.IsTrue(PointIs(sites[0].ClockwisePoints.ElementAt(0), 0, 700)); // #1 D
            Assert.IsTrue(PointIs(sites[0].ClockwisePoints.ElementAt(1), 400, 300)); // #1 A
        ...
        public void ThreePointsInAWedgeTowardsCornerOffset_MirroredAndRotated270()
        {
            ...
            Assert.IsTrue(PointIs(sites[0].ClockwisePoints.ElementAt(0), 0, 300)); // #1 D
            Assert.IsTrue(PointIs(sites[0].ClockwisePoints.ElementAt(1), 400, 700)); // #1 A
        ...
        public void ThreePointsInAWedgeTowardsSideOffsetIntoMiddle()
        {
            ...
            Assert.IsTrue(PointIs(sites[0].ClockwisePoints.ElementAt(0), 0, 200)); // #1 B
            Assert.IsTrue(PointIs(sites[0].ClockwisePoints.ElementAt(1), 500, 700)); // #1 A
        ...
        public void ThreePointsInAWedgeTowardsSideOffsetIntoMiddle_Rotated90()
        {
            ...
            Assert.IsTrue(PointIs(sites[0].ClockwisePoints.ElementAt(0), 200, 1000)); // #1 B
        ...
        public void ThreePointsInAWedgeTowardsSideOffsetIntoMiddle_Rotated180()
        {
            ...
            Assert.IsTrue(PointIs(sites[0].ClockwisePoints.ElementAt(1), 1000, 800)); // #1 B
            ...
            Assert.IsTrue(SiteHasClockwisePoint(sites[1], 500, 0)); // #2 has D
            Assert.IsTrue(PointIs(sites[1].ClockwisePoints.ElementAt(0), 0, 800)); // #2 C
        ...
        public void FourEquidistantPointsInARectangleAroundMiddle()
        {
            ...
            Assert.IsTrue(PointIs(sites[3].ClockwisePoints.ElementAt(1), 1000, 500)); // #4 E
        ...
        public void FivePointsInAForkedTallCross()
        {
            ...
            Assert.IsTrue(PointIs(sites[2].ClockwisePoints.ElementAt(0), 0, 400)); // #3 E
            Assert.IsTrue(PointIs(sites[2].ClockwisePoints.ElementAt(1), 500, 400)); // #3 A
            ...
            Assert.IsTrue(PointIs(sites[4].ClockwisePoints.ElementAt(2), 1000, 400)); // #5 F
        ...
        public void FivePointsInAForkedTallCross_Rotated90()
        {
            ...
            Assert.IsTrue(PointIs(sites[2].ClockwisePoints.ElementAt(1), 400, 500)); // #3 A
        ...
        public void FivePointsInAForkedTallCross_Rotated180()
        {
            ...
            Assert.IsTrue(PointIs(sites[2].ClockwisePoints.ElementAt(1), 1000, 600)); // #3 E
            ...
            Assert.IsTrue(PointIs(sites[3].ClockwisePoints.ElementAt(1), 500, 1000)); // #4 G
            ...
            Assert.IsTrue(PointIs(sites[4].ClockwisePoints.ElementAt(0), 0, 600)); // #5 F
            Assert.IsTrue(PointIs(sites[4].ClockwisePoints.ElementAt(1), 500, 600)); // #5 A
            Assert.IsTrue(PointIs(sites[4].ClockwisePoints.ElementAt(2), 500, 300)); // #5 B
        ...
        public void FivePointsInAForkedTallCross_Rotated270()
        {
            ...
            Assert.IsTrue(PointIs(sites[1].ClockwisePoints.ElementAt(2), 600, 500)); // #2 A
            ...
            Assert.IsTrue(PointIs(sites[4].ClockwisePoints.ElementAt(1), 600, 1000)); // #5 F
            Assert.IsTrue(PointIs(sites[4].ClockwisePoints.ElementAt(2), 600, 500)); // #5 A
        ...
        public void SixPointsInADoubleCross()
        {
            ...
            Assert.IsTrue(PointIs(sites[0].ClockwisePoints.ElementAt(1), 500, 1000)); // #1 H
            Assert.IsTrue(PointIs(sites[0].ClockwisePoints.ElementAt(2), 500, 700)); // #1 B
            Assert.AreEqual(3, sites[1].ClockwisePoints.Count()); // #2
            Assert.IsTrue(SiteHasClockwisePoint(sites[1], 500, 700)); // #2 has B
            ...
            Assert.IsTrue(PointIs(sites[4].ClockwisePoints.ElementAt(0), 0, 300)); // #5 D
